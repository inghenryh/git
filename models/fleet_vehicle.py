...
class FleetVehicle(models.Model):
    ...
    gps_last_location = fields.Char(string='Última Ubicación (Lat, Lon)', readonly=True, help="Última ubicaci>
    gps_last_update = fields.Datetime(string='Última Actualización', readonly=True, help="Fecha y hora de la >
            ...
            if vehicle.gps_imei:
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        vehicle.gps_last_location = f"{data.get('lat')}, {data.get('lng')}" if data.get('lat'>
